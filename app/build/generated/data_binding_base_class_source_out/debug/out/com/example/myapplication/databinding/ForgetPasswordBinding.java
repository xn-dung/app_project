...
public final class ForgetPasswordBinding implements ViewBinding {
  ...
  private ForgetPasswordBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnBack,
      @NonNull Button btnSubmit, @NonNull EditText edtEmail, @NonNull TextView errorMessage,
  ...
  public static ForgetPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ForgetPasswordBinding((ConstraintLayout) rootView, btnBack, btnSubmit, edtEmail,
