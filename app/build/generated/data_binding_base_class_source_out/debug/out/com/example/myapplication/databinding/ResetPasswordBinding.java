...
public final class ResetPasswordBinding implements ViewBinding {
  ...
  private ResetPasswordBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSubmit,
      @NonNull EditText edtPassword, @NonNull EditText edtRePassword,
  ...
  public static ResetPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ResetPasswordBinding((ConstraintLayout) rootView, btnSubmit, edtPassword,
